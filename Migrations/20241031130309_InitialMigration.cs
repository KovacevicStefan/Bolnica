...
namespace arhitektura_projekat.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Slika = table.Column<string>(type: "text", nullable: true),
                    Oznaka = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Naziv = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Lokacija = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Slika = table.Column<string>(type: "text", nullable: true),
                    BolnicaId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Odeljenje", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Odeljenje_Bolnica_BolnicaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Zdr_osiguranje = table.Column<bool>(type: "boolean", nullable: false),
                    DatumRodjenja = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Slika = table.Column<string>(type: "text", nullable: true),
                    OdeljenjeId = table.Column<int>(type: "integer", nullable: false),
                    DijagnozaId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pacijent", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Pacijent_Dijagnoza_DijagnozaId",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pacijent_Odeljenje_OdeljenjeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Odeljenje_BolnicaId",
                schema: "public",
                table: "Odeljenje",
                column: "BolnicaId");

            migrationBuilder.CreateIndex(
                name: "IX_Pacijent_DijagnozaId",
                schema: "public",
                table: "Pacijent",
                column: "DijagnozaId");

            migrationBuilder.CreateIndex(
                name: "IX_Pacijent_OdeljenjeId",
                schema: "public",
                table: "Pacijent",
                column: "OdeljenjeId");
        }
